...
# with command line options: Configuration/GenProduction/python/VBF_SMEFTsim_topU3l_NP1-fragment.py --python_filename VBF_SMEFTsim_topU3l_NP1_cfg.py --eventcontent NANOAODGEN --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAOD --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=123\nprocess.rivetProducerHTXS.ProductionMode='VBF' --fileout file:VBF_SMEFTsim_topU3l_NP1_123.root --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --step LHE,GEN,NANOGEN --geometry DB:Extended --era Run2_2016 --no_exec --mc -n 1000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/VBF_SMEFTsim_topU3l_NP1-fragment.py nevts:1000'),
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:VBF_SMEFTsim_topU3l_NP1_123.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/uscms/home/jennetd/nobackup/mc-gen/eft/genproductions/bin/MadGraph5_aMCatNLO/VBF_SMEFTsim_topU3l_NP1_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),

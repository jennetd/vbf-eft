...
options.register('gridpackDir',  '/uscms/home/jennetd/nobackup/mc-gen/eft/genproductions/bin/MadGraph5_aMCatNLO', VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.string,  "Which Gridpack directory?")
options.register('gridpack',  'VBF_SMEFTsim_topU3l_NP1_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz',  VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.string,  "Which Gridpack?")
...
options.gridpackDir  = os.path.expandvars( options.gridpackDir )
...
# with command line options: Configuration/GenProduction/python/fragment_NMSSM_XYH_YTobb_HToWWTo2QLNu_MX_2000_MY_200.py --conditions 102X_upgrade2018_realistic_v15 -n 100 --eventcontent AODSIM --fast --step LHE,GEN,SIM,RECOBEFMIX,DIGI,DATAMIX,L1,DIGI2RAW,L1Reco,RECO --datatier AODSIM --beamspot Realistic25ns13TeVEarly2018Collision --pileup_input dbs:/Neutrino_E-10_gun/RunIIFall17FSPrePremix-PUMoriond18_102X_upgrade2018_realistic_v15-v2/GEN-SIM-DIGI-RAW --era Run2_2018_FastSim --procModifiers premix_stage2 --datamix PreMix --nThreads 8 --geometry DB:Extended --no_exec --mc --customise Configuration/DataProcessing/Utils.addMonitoring -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('fragment_NMSSM_XYH_YTobb_HToWWTo2QLNu_MX_2000_MY_200.py nevts:100'),
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:VBFH_SMEFTsim.root'),
